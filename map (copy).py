...
class Car(Widget):
    ...
    def move(self, rotation):
        ...
        self.signal1 = int(np.sum(sand[int(self.sensor1_x)-10:int(self.sensor1_x)+10, int(self.sensor1_y)-10:int(self.sensor1_y)+10]))/400.# initially was 400
...
class Game(Widget):
    ...
    def update(self, dt):
       ...
       # angle_bet_dest = dl.angle_between((self.car.x,self.car.y,0),(goal_x,goal_y,0))
        ...
        if distance < 100:
            ...
            last_reward = 0.3
            if (time_max >=time_elapsed -last_tm):
                time_max =time_elapsed -last_tm
                last_reward = 2.0
            else:
                last_reward=1.0
            last_tm=0
